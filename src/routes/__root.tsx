...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "DeckMaker Pro — Market Research Deck Builder" },
      {
        name: "description",
        content:
          "Herramienta interna para consultoras de investigación de mercados: transforma datos en presentaciones ejecutivas.",
      },
      { property: "og:title", content: "DeckMaker Pro — Market Research Deck Builder" },
      {
        property: "og:description",
        content: "Del brief al PowerPoint ejecutivo, con la IA como copiloto del analista.",
      },
